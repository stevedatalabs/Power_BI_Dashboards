...
![Dashboard Page](/Images/Project%202%20Page%201.png)

[🌐**View Interactive dashboard here on the power BI service**](https://app.powerbi.com/view?r=eyJrIjoiODVlMTVmN2UtN2E4MS00NTNlLTk3YTUtNzZlOWYyNmYyZjU4IiwidCI6IjUyNjEyY2YzLWI2MDItNDgzYS04MDY1LTE1NjZhNTUyMDgxOSJ9)
...
* **🎛️ Parameters:** Created dynamic, user-driven reports by using Power BI parameters to adjust filters, scenario inputs, and calculations on the fly, enabling flexible data exploration and interactive dashboards.
* **📊 Visualizations Utilized:**
    * **📈 Core Charts:**  Stacked bar charts for comparisons.
    * **🔢 Cards:** To highlight key performance indicators.
* **🖱️ Interactive Features:**
    * **🎚️ Slicers:** Enabling dynamic, user-driven data filtering.
    * **🔘 Buttons & Bookmarks:** For streamlined navigation and managing report views (Clear all slicers).
---
